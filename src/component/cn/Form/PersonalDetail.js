        ...
        return (
            <div className="col-md-10 col-center">
                ...
                <form onSubmit={this.handleSubmit}>
                    <h5>Individual Applicant 个人申请</h5>
                    ...
                    <SelfCertification/>
                    <a href="javascript:void(0);" id="0" onClick={this.addSelfCertification} className="btn btn-primary">
                        More 更多
                    </a>
                    ...
                    {/* <Link to="account-information" className="btn btn-primary">下一步 > </Link> */}
                </form>
            </div>
        );
    }
